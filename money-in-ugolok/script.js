...
🏆 Таблица лидеров и достижения
        ...
        // Инициализация после старта игры
        ...
        function renderCases() {
            ...
            cases.forEach((caseItem, index) => {
                ...
                caseElement.innerHTML = `
                    ...
                    <div class="case-price">${formatNumber(caseItem.price)} 💎</div>
                `;
        ...
        function openCaseModal(caseItem) {
            ...
            console.log('Case price:', caseItem.price);
            ...
            if (casePrice) casePrice.textContent = formatNumber(caseItem.price);
